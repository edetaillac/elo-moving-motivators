...
const messages: Record<Locale, Dict> = {
  fr: {
    'header.subtitle.onboarding': 'Découvre ce qui te motive vraiment parmi 10 leviers de motivation.',
    'header.subtitle.duel': 'Choisis la carte qui te motive le plus à chaque duel.',
    ...
    'onboarding.lead': "Deux motivateurs s'affrontent, tu choisis celui qui te parle le plus. Au fil des duels, ton classement personnel se précise.",
  ...
  en: {
    'header.subtitle.onboarding': 'Discover what really drives you among 10 motivation levers.',
    'header.subtitle.duel': 'Pick the card that motivates you most in each duel.',
    'header.duels': '{n} duel{s}',
    ...
    'onboarding.lead': 'Two motivators face off — you pick the one that speaks to you most. Duel after duel, your personal ranking takes shape.',
