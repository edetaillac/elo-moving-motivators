...
const messages: Record<Locale, Dict> = {
  fr: {
    ...
    'progress.duel': 'Duel {n}',
    'progress.toUnlock': '{p}% vers le classement',
    'arena.title': 'Quel motivateur compte le plus ?',
    'arena.subtitle': 'Choisis-en un. Duel après duel, ton classement se dessine.',
    'arena.wins': '{name} l\'emporte',
    ...
    'onboarding.estimate': 'Tu joueras {b}, chaque motivateur face à tous les autres.',
    'onboarding.estimateBold': '45 duels',
    'onboarding.namePlaceholder': 'Ton prénom',
    'onboarding.cta': "C'est parti",
    'onboarding.mode.label': 'Mode de jeu',
    'onboarding.mode.prefix': 'Mode :',
  ...
  en: {
    ...
    'progress.duel': 'Duel {n}',
    'progress.toUnlock': '{p}% to unlock',
    'arena.title': 'Which motivator matters most?',
    'arena.subtitle': 'Pick one. Duel after duel, your ranking takes shape.',
    'arena.wins': '{name} wins',
    ...
    'onboarding.estimate': 'You will play {b}, each motivator against every other.',
    'onboarding.estimateBold': '45 duels',
